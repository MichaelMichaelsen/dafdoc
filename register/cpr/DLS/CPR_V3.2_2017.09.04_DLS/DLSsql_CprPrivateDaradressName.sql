...
[For komplet forretningslogik : Se Bilag 23 - Afsnittet Private Tjenester- Søgning på navne]
	...
	/* Anvendes i søgning med DarId og navn : CprPrivateDarIdName */
        IF (@cadr.daradresse.eq  IS NOT NULL)
        //DAROPSLAG (på CPR's DARID)
          @cadr.daradresse.eq = Adresse.daradresse
