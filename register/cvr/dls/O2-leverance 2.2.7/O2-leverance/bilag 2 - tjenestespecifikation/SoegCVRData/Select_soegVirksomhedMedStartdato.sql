...
FROM 
CVREnhed as CVRE 
inner join Virksomhed 				as v 	on v.id = CVRE.id and VirksomhedStartdato = pVirksomhedStartdato	/*Filter på VirksomhedStartdato*/
...
left join branche 					as Hb 	on v.id = Hb.cvrenhedsid 	and hb.sekvens  = 0 /*anvendes ved Hovbranche Search Kreterer*/
left join branche 					as bb1 	on v.id = bb1.cvrenhedsid  	and bb1.sekvens = 1 /*anvendes ved Bi branche 1 Search Kriterer*/
left join branche 					as bb2 	on v.id = bb2.cvrenhedsid 	and bb2.sekvens = 2 /*anvendes ved Bi branche 2 Search Kriterer*/
left join branche 					as bb3 	on v.id = bb3.cvrenhedsid 	and bb3.sekvens = 3 /*anvendes ved Bi branche 3 Search Kriterer*/
