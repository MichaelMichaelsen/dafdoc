...
left join adressering 		as ap 	on P.id = ap.cvrenhedsid 													/*anvendes ved postadresse*/
left join adressering 		as ab 	on p.id = ab.cvrenhedsid 													/*anvendes ved beliggenhedsadresse*/
left join branche 			as Hb 	on P.id = Hb.cvrenhedsid 	and hb.sekvens  = 0 and hb.Vaerdi 	= pBranche	/*anvendes ved Hovbranche Search Kreterer*/
left join branche 			as bb1 	on p.id = bb1.cvrenhedsid  	and bb1.sekvens = 1 and bb1.Vaerdi = pBranche	/*anvendes ved Bi branche 1 Search Kriterer*/
left join branche 			as bb2 	on p.id = bb2.cvrenhedsid 	and bb2.sekvens = 2 and bb2.Vaerdi = pBranche	/*anvendes ved Bi branche 2 Search Kriterer*/
left join branche 			as bb3 	on p.id = bb3.cvrenhedsid 	and bb3.sekvens = 3 and bb3.Vaerdi = pBranche	/*anvendes ved Bi branche 3 Search Kriterer*/
