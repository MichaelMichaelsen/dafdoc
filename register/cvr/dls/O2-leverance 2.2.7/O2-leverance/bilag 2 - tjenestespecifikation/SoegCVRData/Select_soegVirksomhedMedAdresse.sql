...
Left join adressering 				as ap 	on v.id = ap.cvrenhedsid and ap.adresse = pAdresse 	/* filter på adresse*/
Left join adressering 				as ab 	on v.id = ab.cvrenhedsid and ab.adresse = pAdresse 	/* filter på adresse*/
