...
left join adressering 		as ab 	on A.id = ab.cvrenhedsid and ab.adresseringanvendelse = 'beliggenhedsadresse' /*anvendes ved beliggenhedsadresse*/
where
a.CPRPerson = pCPRPerson and /*filter på CPRPerson*/
