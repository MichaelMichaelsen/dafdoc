...
R.registreringfra 	= (select max(registreringfra) from reklamebeskyttet  	as kr  where P.id = Rr.cvrenhedsid		and registreringfra <= pRegistreringstid)) and 						/* anvendes ved reklamebeskyttet*/ 
